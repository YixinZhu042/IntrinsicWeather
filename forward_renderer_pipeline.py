...
from diffusers.loaders import SD3LoraLoaderMixin, StableDiffusionLoraLoaderMixin
...
class StableDiffusion3InstructPix2PixPipeline(DiffusionPipeline, SD3LoraLoaderMixin):
    r"""
    Args:
